...
const0 = Const()
binarygeneratorimplementation0 = BinaryGeneratorImplementation(bits_num=1024000, )
qammodulator0 = QAMModulator(bits_per_symbol=2, )
bercalculator0 = BERCalculator()
qamdemodulator0 = QAMDemodulator(bits_per_symbol=2, constellation=qammodulator0.constellation)
...
c4 = ConnectionImplementation(binarygeneratorimplementation0.outputs[0], qammodulator0.inputs[0])
c5 = ConnectionImplementation(binarygeneratorimplementation0.outputs[1], bercalculator0.inputs[0])
